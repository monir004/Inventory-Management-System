...
<html lang="en">
    ...
    <body>
        ...
        <table id="customers">
            ...
            <%
                List<Order> orders = (List<Order>) request.getAttribute("orderLists");
                for (int i = 0; i < orders.size(); i++) {
                    Order order = orders.get(i);
            %>
            <tr>
                 <td align="center"> <%= order.getSalesman()%> </td>
                <td align="center"> <%= order.getCustomer() %> </td>
                <td align="center"> <%= order.getPurchase_date() %> </td>
                <td align="center"> <%= order.getTotal_amount()  %> </td>
                <td> <a href= "<%= "SaleDetailsFromHistory?id=" + order.getId()%>" class="btn btn-success"> Invoice</a></td>
